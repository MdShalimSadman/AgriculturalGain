...
<input type="submit" style="background-color:green; color:white;font-size:19px; border:RGB(46,139,87); float:left"  value="         Home          " name="btnClick101">
</form>
...
<h4 style="color:white;float:right">switch to <a style="color:green" href="../view/Home page - bn.php">বাংলা</a></h4><br>
<style>
body {
...
given the name of our project <b>‘Agricultural gain’.</b><br><br><br></p><br> <br><br><br>
</div>
...
<table class="center">
    ...
    <tr>
        <td style="background-image:url(../view/Farmer.jpg);background-repeat: no-repeat;" height=200 width=400><a href=""><h1 style="color:white;font-size:90px;"><br><br><br>Farmer</h1></a> </td>
