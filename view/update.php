...
else
{
	...
	$q="UPDATE agriculturist_info SET user_name='".$_POST["uname"]."',Password='".$_POST["pass"]."',Email='".$_POST["email"]."',Gender='".$_POST["gender"]."',Institute='".$_POST["institute"]."',Address='".$_POST["address"]."',Expertizes='".$work."',About='".$_POST["bio"]."' WHERE user_name='".$_SESSION["uname"]."'";
	$result=$conn->query($q);
	if($result)
	  echo "data updated";
    else
